...
//        operatorRightShoulder.whileHeld(new AutoIntake(shooter, intake, conveyor, AutoIntake.IntakeType.FORCED_CONVEYOR_INTAKE));
    ...
    public Command getBarrelRacingPath() {
        return new BarrelRacingPath(drivetrain);
    }

    public Command getSlalomPath() {
        return new SlalomPath(drivetrain);
    }

    public Command getBouncePath() {
        return new BouncePath(drivetrain);
    }

    public Command getGalacticSearchA() {
        return new GalacticSearchA(drivetrain, shooter, intake, conveyor);
    }

    public Command getGalacticSearchB() {
        return new GalacticSearchB(drivetrain, shooter, intake, conveyor);
    }
